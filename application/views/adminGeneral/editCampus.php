		...
		<div class="span9"><div class="well">
			<div class="row-fluid"><div class="span12"><h3>Esta es la lista actual de Campus de la UTEM</h3></div></div>

						<?php 
						$attributes = array('class' => 'form-horizontal', 'role' => 'form');
						 ?> 					
					    <?php 
						    echo form_open('intranet/modificarCampus',$attributes);
				    				foreach ($camp as $sede) {
										echo '<div class="form-group">
											    ...
											    <div class="col-sm-4">
													...
													<input class="form-control" readonly="readonly" type="text" value="'.$sede->nombre.'"> <span class="input-group-addon"><span class="icon-check"></span></span></div>
												</div>	
